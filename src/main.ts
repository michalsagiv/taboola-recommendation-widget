...
import { renderError, renderRecommendations, renderSkeleton } from "./dom.js";

import { RecommendationRequest } from "./types.js";
...
const bootstrap = async ({ containerId = "taboola-widget" }: BootstrapOptions = {}) => {
